...
public class MimeTypeUtil {
	 ...
	 * @throws IOException
	 *//*
	public String lookupMimeTypeByFileName(String absoluteFileName) throws IOException {
	...
	*//**
	 ...
	 * @throws IOException
	 *//*
	public String lookupMimeTypeByFileName(String rootDirectory, String currentFolder, String fileName)
			throws IOException {

		Path target = Paths.get(SystemUtil.formatPathForOS(rootDirectory, currentFolder, fileName));
	...
	*//**
	 ...
	 * @throws IOException
	 *//*
	public static String getFileMimeTypeFromBytes(String absoluteFileName) throws IOException {
		...
		fileType = mt.getMediaType();
		System.err.println("Media type: " + mt.getMediaType());
		System.err.println("Sub Type: " + mt.getSubType());
		}
		...
		if (!Files.exists(target) || Files.isDirectory(target)) {
			System.err.println("No such file!" + target);
			 ...
			 fileType = MimeUtil.getExtension(target.toFile());//Files.probeContentType(target);
		}

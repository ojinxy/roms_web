...
/**
 * 
 * @author jreid Created Date: Jul 26, 2013
 */
public class FileExtensionUtil {
	...
	private static HashMap<String, String> mimeExtensionMapping;

	static {
		mimeExtensionMapping = new HashMap<String, String>(200) {
			private void put1(String key, String value) {
				if (put(key, value) != null) {
					// throw new
					// IllegalArgumentException("Duplicated extension: " + key);
				}
			}
	...
	public static void main(String[] args) {
		System.out.println(mimeExtensionMapping.size());
	}

	/* *//**
	 * Registers MIME type for provided extension. Existing extension type
	 * will be overriden.
	 */
	/*
	 * public static void registerMimeType(String ext, String mimeType) {
	 * mimeExtensionMapping.put(ext, mimeType); }
	 */

	/**
	 * Simply returns Extension type or <code>null</code> if no type is found.
	 */
	public static String lookupExtension(String mimeCode) {
		return mimeExtensionMapping.get(mimeCode.toLowerCase());
	}
	 ...
	 */
	/*
	 * public String lookupFileExtensionByFileName(String absoluteFileName)
	 * throws IOException {
	 * 
	 * Path target = Paths.get(SystemUtil.formatPathForOS(absoluteFileName));
	 * 
	 * if (!Files.exists(target) || Files.isDirectory(target)) {
	 * System.err.println("No such file!" + target); throw new
	 * FileNotFoundException("This file does not exist."); } else {
	 * 
	 * String mimeCode = Files.probeContentType(target); String extension =
	 * null;
	 * 
	 * if (StringUtils.isNotBlank(mimeCode)) { extension =
	 * lookupExtension(mimeCode); }
	 * 
	 * System.err.println(" File type is ::" + extension); return extension; }
	 * 
	 * }
	 *//**
	 * 
	 ...
	 */
	/*
	 * public String lookupFileExtensionByFileName(String rootDirectory, String
	 * currentFolder, String fileName) throws IOException {
	 * 
	 ...
	 * 
	 * if (StringUtils.isNotBlank(mimeCode)) { extension =
	 * lookupExtension(mimeCode); } System.err.println(" File type is ::" +

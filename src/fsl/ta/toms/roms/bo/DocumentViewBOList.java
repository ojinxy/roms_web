...
public class DocumentViewBOList extends ArrayList<DocumentViewBO> implements Serializable {
	 ...
	 * @param summons
	 */
	public DocumentViewBOList(SummonsDO summons) {
		super();
	...
	public DocumentViewBOList(WarningNoticeDO warningNotice) {
		super();
	...
	public DocumentViewBOList(WarningNoProsecutionDO warningNotice) {
		super();
	...
	public DocumentViewBOList(String documentTypeCode, String documentTypeName,

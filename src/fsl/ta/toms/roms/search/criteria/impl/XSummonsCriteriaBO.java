 ...
 */
public class XSummonsCriteriaBO implements SearchCriteria {

	
	private static final long serialVersionUID = 1L;

	
	private Integer summonsId;
	Date summonsStartDateRange;
	Date summonsEndDateRange;
	...
	/**
	 * @return the summonsStartDateRange
	 */
	public Date getSummonsStartDateRange() {
		return summonsStartDateRange;
	}
	/**
	 * @param summonsStartDateRange the summonsStartDateRange to set
	 */
	public void setSummonsStartDateRange(Date summonsStartDateRange) {
		this.summonsStartDateRange = summonsStartDateRange;
	}
	/**
	 * @return the summonsEndDateRange
	 */
	public Date getSummonsEndDateRange() {
		return summonsEndDateRange;
	}
	/**
	 * @param summonsEndDateRange the summonsEndDateRange to set
	 */
	public void setSummonsEndDateRange(Date summonsEndDateRange) {
		this.summonsEndDateRange = summonsEndDateRange;
	}
	/**
	...
	/**
	 * @param jpRegNumber the jpRegNumber to set
	 */
	...
	/**
	 * @param jpFirstName the jpFirstName to set
	 */
	...
	/**
	 * @param jpLastName the jpLastName to set
	 */

 ...
 */
public class WarningNoProReportCriteriaBO extends ParentReportCriteria
		implements Serializable, ReportSearchCriteria 
{
	...
	public WarningNoProReportCriteriaBO(Date operationStartDate,
	...
	public WarningNoProReportCriteriaBO() {
		super();
